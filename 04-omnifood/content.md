...
One hash is for the main heading, two is for secondary heading and so on.
...
- Logo + Navigation (although it is a landing page, it is still useful to have some links at the top which lead the user to different sections of the website)
- Hero
- Feature in
- How it works
- Diets
